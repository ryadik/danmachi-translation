...
- [ ] рефакторинг промпта на перевод (чтобы соответствовал стайлгайду).
- [ ] этап вычитки
  - [ ] полный анализ и исправление текста на соответсвтие стайлгаду
  - [ ] улучшение литературности и читаемости текста.
