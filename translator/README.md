...
### ВАЖНО
**Мне абсолютно не хотелось заморачиваться, так что скрипт _полностью навайблен_ (написан через Gemini 2.5 pro), поэтому какое качество кода, я безпонятия. Ззаточен только под перевод данного тайтла.**
